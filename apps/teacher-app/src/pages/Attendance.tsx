  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        ...
        <p className="page-subtitle mt-1">Monitor student attendance across your courses</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        <div className="surface-card p-6">
          ...
          <p className="text-3xl font-semibold tracking-tight">{data?.summary.average ?? 0}%</p>
        </div>
        <div className="surface-card p-6">
          <div className="flex items-center justify-between mb-4">
          ...
          <p className="text-3xl font-semibold tracking-tight">{data?.summary.atRisk ?? 0}</p>
        ...
        <div className="surface-card p-6">
          ...
          <p className="text-3xl font-semibold tracking-tight">{data?.summary.totalClasses ?? 0}</p>
        </div>
      </div>

      <div className="surface-card p-6">
        <div className="mb-5">
          <h2 className="text-lg font-semibold tracking-tight">Student Attendance Records</h2>
          <p className="page-subtitle mt-0.5">Aggregated from recorded class sessions</p>
